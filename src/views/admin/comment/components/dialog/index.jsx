...
const CommentDialog = (props) => {
  ...
  const [targetComponent, setTargetComponent] = useState("CONTENT");
      ...
      return selected[key] ? (
        <div className="flex items-center justify-between rounded-lg border border-gray-200 bg-white px-4 py-2 shadow-md transition-all hover:shadow-lg">
          <p className="text-lg font-semibold text-gray-800">
            {selected[key]?.name ? selected[key].name : selected[key]?.id}
          </p>
        </div>
      ) : (
        <div></div>
      ...
      case "CONTENT":
        return (
          <Content
            ...
            actionButtons={(data) => actionButtons(data, "target")}
          />
        );
      case "MEDIA":
        return (
  ...
  return (
    ...
    >
      <div className="flex min-h-screen items-center justify-center">
        <Dialog.Panel className="z-20 h-full max-h-[80vh]  w-full max-w-lg overflow-y-auto rounded-lg border border-gray-300 bg-white p-6 shadow-lg dark:border-brand-400 dark:!bg-navy-900">
          <Dialog.Title
            as="h3"
                ...
                <div className="flex flex-row justify-between gap-2">
                  <div className="flex-1">
                    <Selectdialog
                      ...
                      onClose={() => clearFormik("targetId", "target")}
                    />
                  </div>
                  <div className="flex-1">
                    <button
                  ...
                  <div className="flex flex-row justify-between gap-2">
                    <div className="flex-1">
                      <Selectdialog
                        ...
                        onClose={() => clearFormik("parentId", "parent")}
                      />
                    </div>
                    <div className="flex-1">
                      <button
                ...
                <div className="flex flex-row justify-between gap-2">
                  <div className="flex-1">
                    <Selectdialog
                      ...
                      onClose={() => clearFormik("userId", "user")}
                    />
                  </div>
                  <div className="flex-1">
                    <button
