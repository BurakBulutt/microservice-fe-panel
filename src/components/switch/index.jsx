const Switch = (props) => {
  ...
  return (
    <input
      type="checkbox"
      className={`relative h-6 w-12 appearance-none rounded-[20px] bg-[#e0e5f2] outline-none transition duration-[0.5s] 
      ...
      checked:before:translate-x-[27px] hover:cursor-pointer
      dark:bg-white/5 ${
        color === "red"
